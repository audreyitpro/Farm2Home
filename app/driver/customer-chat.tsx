...
export default function DriverCustomerChatScreen() {
  ...
  async function loadMessages(driverId: string) {
    ...
    if (error) {
      console.log("Driver customer chat load skipped:", error.message);
      setMessages([]);
      return;
    }
    ...
    return (
      <SafeAreaView style={styles.safe}>
        ...
        <View style={styles.center}>
          ...
          <Text style={styles.centerText}>Loading customer chat...</Text>
        </View>
      </SafeAreaView>
    );
  }
